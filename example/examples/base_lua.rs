...
mod hello {
    ...
    fn lua_hello_world(lua: &mlua::Lua, (): ()) -> mlua::Result<String> {
    ...
    async fn lua_hello_human(lua: mlua::Lua, (name): (String)) -> mlua::Result<Human> {
    ...
    mod say {
        ...
        fn lua_bye(lua: &mlua::Lua, (): ()) -> mlua::Result<String> {
            bye().map_err(cmod::ffi::lua::map_err)
        }

        pub fn lua_module_say(lua: &mlua::Lua, father: &mlua::Table) -> mlua::Result<()> {
